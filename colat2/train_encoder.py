...
def train(cfg: DictConfig) -> None:
    ...
    optimizer: torch.optim.Optimizer = instantiate(
        ...
        list(model.parameters()) + list(model2.parameters()) + list(projector.parameters()) + list(dre_model.parameters())
        if cfg.train_projector
        else list(model.parameters()) + list(model2.parameters()) + list(dre_model.parameters()),
    )
